  ...
  <head>
	...
	$(function(){
		$('#choice').change(function(){
			location.href = 'EditNews.jsp?worksType=' + $(this).val();
		});
	})();
	</script>
  </head>
...
<div id="layout"><div align="center">	 
	...
	<form enctype="multipart/form-data" method="post" action="<%=basePath %>servlet/AddNews?" name="addNews" class="niceform" target="_self">
    	...
    	新闻类型：<select id="choice" name="worksType" size="1">
        ...
        <input id="style2" type="submit" name="submit" value="确定" />
