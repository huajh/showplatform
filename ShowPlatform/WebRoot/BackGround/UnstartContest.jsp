...
<table align="center" bordercolor="#CCCCCC" border="1" height="70" cellpadding="0" cellspacing="0" bgcolor="#EEF2FB">
	<tr>
        ...
        <th width="120">开始比赛</th>
    </tr>
    <%
    	Collection contestCollection = PublicOperator.getUnstartContest();
    	if(contestCollection!=null)
    	{
	    	...
	    	%>
	    		<form action="<%=basePath %>servlet/StartContest?contestID=<%=contest.getContestID()%>" method="post" class="niceform" target="_self">
	    	<%
	    		out.println("<input type='submit' align='middle' name='permit' value='开始' />");
	    		out.println("</th>");
	    	%>
	    		</form>
	    	<%
