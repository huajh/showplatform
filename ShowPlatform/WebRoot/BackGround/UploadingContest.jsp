...
<h3 align="center">处于上传作品阶段的比赛</h3>
<table align="center" bordercolor="#CCCCCC" border="1" height="70" cellpadding="0" cellspacing="0" bgcolor="#EEF2FB">
    ...
    <%
    	...
    	if(contestCollection!=null)
    	{
	    	...
	    	%>
	    		<form action="<%=basePath %>servlet/StartScore?contestID=<%=contest.getContestID()%>" method="post" class="niceform" target="_self">
	    	<%
	    		out.println("<input type='submit' align='middle' name='permit' value='开始评分' />");
	    		out.println("</th>");
	    	%>
	    		</form>
	    	<%
